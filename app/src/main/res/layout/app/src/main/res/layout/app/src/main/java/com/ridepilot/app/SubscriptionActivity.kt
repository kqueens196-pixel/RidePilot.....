    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnPay.setOnClickListener {
            ...
            val uri = Uri.Builder()
                .scheme("upi")
                .authority("pay")
                .appendQueryParameter("pa", "ridepilot@upi") // Aapki UPI ID yahan aayegi
            ...
            try {
                ...
                Toast.makeText(this, "No UPI App Found. Opening Dashboard directly...", Toast.LENGTH_SHORT).show()
                proceedToDashboard()
            }
        }

        btnTrial.setOnClickListener {
            Toast.makeText(this, "Free Trial Activated for 24 Hours!", Toast.LENGTH_SHORT).show()
            proceedToDashboard()
        }
    }
